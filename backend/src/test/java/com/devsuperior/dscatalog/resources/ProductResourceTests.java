...
public class ProductResourceTests {
    ...
    void setup() throws Exception {
        ...
        PageImpl<ProductDTO> page = new PageImpl<>(List.of(dto));
    ...
    public void findByIdShouldReturnProductWhenIdExists() throws Exception {
        ResultActions result = mockMvc.perform(get("/products/{id}", existingId).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
        result.andExpect(jsonPath("$.id").exists());
    }
