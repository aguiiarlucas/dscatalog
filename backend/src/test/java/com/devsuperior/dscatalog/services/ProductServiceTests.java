...
public class ProductServiceTests {
    ...
    void setUp() throws Exception {
        ...
        Mockito.when(categoryRepository.getOne(existingId)).thenReturn(cat);
    ...
    @Test
    public void findByIdThrowResourceNotFoundExceptionWhenIdExists() {
    ...
    @Test
    public void updateThrowResourceNotFoundExceptionWhenIdExists() {
        Assertions.assertThrows(ResourceNotFoundException.class, () -> {
